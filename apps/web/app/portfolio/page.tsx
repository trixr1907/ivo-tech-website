...
const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: 'Interaktive Web-Anwendung für 3D-Druck-Aufträge mit Live-Kostenkalkulation und STL-File-Viewer.',
  ...
  },
  {
    ...
    description: 'Real-time Kryptowährungs-Portfolio-Tracker mit Live-Preisen, P&L-Tracking und Portfolio-Analyse.',
    category: 'FinTech',
  ...
  },
  {
    ...
    description: 'IoT-Dashboard für Sensor-Datenvisualisierung mit MQTT-Integration und historischer Datenanalyse.',
    category: 'IoT',
...
const categories = ['Alle', 'Web Development', 'DevOps', '3D Printing', 'Backend', 'FinTech', 'IoT'];
...
export default function Portfolio() {
  ...
  const filteredProjects =
    activeCategory === 'Alle' ? portfolioData : portfolioData.filter(item => item.category === activeCategory);
    ...
    <div className='min-h-screen bg-gray-900 text-white'>
      ...
      <main className='pb-12 pt-24'>
        ...
        <section className='bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-20'>
          <div className='container mx-auto px-4 text-center'>
            ...
            <p className='mx-auto mb-8 max-w-3xl text-xl text-gray-300'>
              Entdecken Sie unsere erfolgreich realisierten Projekte - von modernen Webanwendungen bis hin zu
              innovativen IoT-Lösungen und 3D-Druck-Anwendungen.
            </p>
                  ...
                  <div className='mb-4'>
                    <div className='flex flex-wrap gap-2'>
                      {project.technologies.slice(0, 3).map(tech => (
                        <span key={tech} className='rounded-md bg-gray-700 px-2 py-1 text-xs font-medium text-gray-300'>
                          {tech}
                        </span>
                      ))}
        ...
        <section className='bg-gradient-to-r from-blue-900/20 to-purple-900/20 py-20'>
          <div className='container mx-auto px-4 text-center'>
            <h2 className='mb-4 text-3xl font-bold text-white'>Ihr Projekt ist der nächste Erfolg</h2>
            <p className='mx-auto mb-8 max-w-2xl text-xl text-gray-300'>
              Lassen Sie uns gemeinsam Ihre Vision verwirklichen. Von der Konzeption bis zur Umsetzung - wir sind Ihr
              Partner für innovative Technologielösungen.
            </p>
