    ...
    <div className='min-h-screen bg-gray-900 py-16'>
      <div className='mx-auto max-w-4xl px-4 sm:px-6 lg:px-8'>
        <div className='mb-8'>
          ...
          <div className='font-mono text-sm text-blue-400'>$ cat /legal/datenschutz.md</div>
        </div>

        <div className='space-y-8 text-gray-300'>
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>1. Allgemeine Hinweise</h2>
          ...
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>2. Verantwortliche Stelle</h2>
            <div className='rounded-lg bg-gray-800/30 p-6'>
          ...
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>3. Datenerfassung</h2>
            <div className='rounded-lg bg-gray-800/30 p-6'>
              <p className='mb-4 text-sm'>
          ...
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>4. Verwendung der Daten</h2>
            <div className='rounded-lg bg-gray-800/30 p-6'>
              <p className='mb-4 text-sm'>
          ...
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>5. Ihre Rechte</h2>
            <div className='rounded-lg bg-gray-800/30 p-6'>
          ...
          <section>
            <h2 className='mb-4 text-2xl font-semibold text-white'>6. Cookies und Tracking</h2>
            <div className='rounded-lg bg-gray-800/30 p-6'>
              <p className='text-sm'>
                Diese Website verwendet keine Cookies für Tracking oder Werbezwecke. Technisch notwendige Cookies können
                verwendet werden, um die Funktionalität der Website zu gewährleisten.
              </p>
            </div>
          </section>
