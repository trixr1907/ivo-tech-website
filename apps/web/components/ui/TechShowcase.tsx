...
export function TechShowcase() {
  return (
    <div className='text-center'>
      <h2 className='mb-8 text-3xl font-bold text-white md:text-4xl'>Technologien</h2>
      ...
      <div className='grid grid-cols-2 gap-6 md:grid-cols-3'>
        {technologies.map((tech, index) => (
          ...
          >
            <div className='mb-4 text-4xl transition-transform group-hover:scale-110'>{tech.icon}</div>
