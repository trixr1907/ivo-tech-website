    ...
    >
      ...
      >
        ...
        <defs>
          ...
          {shouldAnimate && (
            <filter id='glow' x='-50%' y='-50%' width='200%' height='200%'>
              ...
              <animateTransform attributeName='stdDeviation' values='2;4;2' dur='2s' repeatCount='indefinite' />
            </filter>
          )}
        ...
        <g transform='translate(50, 80)'>
          ...
          <rect x='230' y='36' width='30' height='8' fill='url(#logoGradient)' />
          <rect x='230' y='72' width='35' height='8' fill='url(#logoGradient)' />

          {/* C */}
          <rect x='280' y='0' width='35' height='8' fill='url(#logoGradient)' />
          <rect x='280' y='72' width='35' height='8' fill='url(#logoGradient)' />
          ...
          <rect x='330' y='36' width='33' height='8' fill='url(#logoGradient)' />
        </g>
        ...
        {shouldAnimate && (
          <g>
            <line x1='0' y1='60' x2='400' y2='60' stroke={colors.primary} strokeWidth='1' opacity='0.4'>
              <animateTransform attributeName='y1' values='60;180;60' dur='3s' repeatCount='indefinite' />
              <animateTransform attributeName='y2' values='60;180;60' dur='3s' repeatCount='indefinite' />
            </line>

            <line x1='0' y1='120' x2='400' y2='120' stroke={colors.secondary} strokeWidth='1' opacity='0.3'>
              <animateTransform attributeName='y1' values='120;240;120' dur='4s' repeatCount='indefinite' />
              <animateTransform attributeName='y2' values='120;240;120' dur='4s' repeatCount='indefinite' />
            </line>
          </g>
        )}
        ...
        {!shouldAnimate && (
          <g opacity='0.3'>
            <line x1='0' y1='100' x2='400' y2='100' stroke={colors.primary} strokeWidth='1' />
            <line x1='0' y1='140' x2='400' y2='140' stroke={colors.secondary} strokeWidth='1' />
          </g>
        )}
        ...
        <desc>
          Logo der IVO-TECH Firma mit modernem Design und optionalen Animationen. Bei deaktivierter Animation wird eine
          statische Version gezeigt.
        </desc>
      </svg>
