      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 gap-8 md:grid-cols-4'>
          <div className='md:col-span-2'>
            ...
            <p className='mb-4 text-gray-400'>
              Dein Partner für moderne IT-Lösungen. Von Heimserver-Setups bis zur professionellen Webentwicklung - wir
              bringen deine digitalen Projekte zum Leben.
            </p>
            <div className='font-mono text-xs text-green-400'>🚀 Immer erreichbar, immer innovativ</div>
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm'>
              <li>
                <a href='#services' className='text-gray-400 transition-colors hover:text-blue-400'>
                  🌐 Webentwicklung
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm'>
              <li className='flex items-center text-gray-400'>
                ...
                <a href='mailto:kontakt@ivo-tech.com' className='transition-colors hover:text-green-400'>
                  kontakt@ivo-tech.com
                </a>
              </li>
              <li className='flex items-center text-gray-400'>
                <span className='mr-2'>📱</span>
                <a href='tel:+4917612345678' className='transition-colors hover:text-green-400'>
                  +49 176 12345678
                </a>
              </li>
              <li className='flex items-center text-gray-400'>
        ...
        <div className='mt-8 border-t border-gray-800 pt-8'>
          <div className='flex flex-col items-center justify-between gap-4 md:flex-row'>
            <div className='font-mono text-xs text-gray-400'>© 2024 IVO-TECH. Made with ❤️ and ☕ in Germany</div>
