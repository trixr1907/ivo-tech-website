    ...
    <div className="space-y-8">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-gray-300">
          3D/4D Micro-Interactions mit CSS + React Three Fiber
        </p>
      </div>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <p className="text-gray-300">
              Dies ist eine Standard-Neon-Karte mit grundlegenden Hover-Effekten
              und Tiefenanimationen.
            </p>
          </NeonCard>
          ...
          >
            <p className="mb-4 text-gray-300">
              Diese Karte nutzt 3D-Ebenen und reagiert auf Audio-Eingaben im
              4D-Modus.
            </p>
      ...
      >
        <div className="space-y-6">
          <p className="text-gray-300">
            Dies ist ein vollständig funktionales Modal mit 3D-Layering und
            audio-reaktiven Effekten.
          </p>
