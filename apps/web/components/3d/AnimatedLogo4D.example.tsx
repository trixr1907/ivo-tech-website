...
export function AnimatedLogo4DShowcase() {
  return (
    <div className="w-full space-y-8 bg-black p-6">
      ...
      <section>
        <h3 className="mb-4 text-xl text-white">
          High Performance (30fps, reduzierte Effekte)
        </h3>
      ...
      <section>
        <h3 className="mb-4 text-xl text-white">
          Minimal (nur Logo, keine Effekte)
        </h3>
