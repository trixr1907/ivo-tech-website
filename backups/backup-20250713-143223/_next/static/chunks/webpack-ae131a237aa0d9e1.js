(() => {
  ...
  ((r.m = e),
    ...
    (r.u = e => 'static/chunks/' + e + '.' + { 341: 'df3329d77a5faa19', 472: 'a3826d29d6854395' }[e] + '.js'),
    (r.miniCssF = e => {}),
    (r.g = (function () {
    ...
    (() => {
      ...
      r.l = (o, n, a, i) => {
        ...
        if (void 0 !== a)
          for (var u, c, l = document.getElementsByTagName('script'), s = 0; s < l.length; s++) {
            var d = l[s];
