  ...
  [792],
  {
    ...
    3996: (e, t, r) => {
      ...
      function g(e) {
        let {
          ...
          { updateScripts: m, scripts: g, getIsSsr: E, appDir: b, nonce: y } = (0, u.useContext)(l.HeadManagerContext),
          P = (0, u.useRef)(!1);
        (0, u.useEffect)(() => {
          let e = t || r;
      ...
      function c(e, t, r) {
        ...
        for (let f of (0, i.removeTrailingSlash)(e).slice(1).split('/')) {
          ...
          if (e && i && i[2]) {
            ...
            ((n[t] = { pos: l++, repeat: o, optional: r }), c.push('/' + (0, a.escapeStringRegexp)(e) + '([^/]+?)'));
          } else if (i && i[2]) {
            let { key: e, repeat: t, optional: o } = s(i[2]);
            ((n[e] = { pos: l++, repeat: t, optional: o }), r && i[1] && c.push('/' + (0, a.escapeStringRegexp)(i[1])));
            let u = t ? (o ? '(?:/(.+?))?' : '/(.+?)') : '/([^/]+?)';
            ...
            if (void 0 === r) {
              ...
              r =
                (null == (e = window.trustedTypes)
                  ? void 0
                  : e.createPolicy('nextjs', { createHTML: e => e, createScript: e => e, createScriptURL: e => e })) ||
                null;
            }
            return r;
          })())
      ...
      class z {
        ...
        async change(e, t, r, n, o) {
          ...
          (this._inFlightRoute &&
            ...
            (r = (0, R.addBasePath)(
              (0, b.addLocale)((0, v.hasBasePath)(r) ? (0, P.removeBasePath)(r) : r, n.locale, this.defaultLocale)
            )));
          let J = (0, y.removeLocale)((0, v.hasBasePath)(r) ? (0, P.removeBasePath)(r) : r, W.locale);
          ...
          try {
            ...
            if (
              ...
              let e = (0, v.hasBasePath)(ee.pathname) ? (0, P.removeBasePath)(ee.pathname) : ee.pathname;
              if (
                (el &&
                  et !== e &&
                ...
                let e =
                  !Q.shallow && a.resolvedAs
                    ? a.resolvedAs
                    : (0, R.addBasePath)((0, b.addLocale)(new URL(r, location.href).pathname, W.locale), !0);
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            if (
              ...
              t(),
              (null == T || null == (b = T.effect) ? void 0 : b.type) === 'redirect-internal' ||
                (null == T || null == (y = T.effect) ? void 0 : y.type) === 'redirect-external')
            )
              return T.effect;
            ...
            let j =
              ...
              A = null == T || null == (v = T.response) ? void 0 : v.headers.get('x-middleware-skip'),
          ...
          ((this.sdc = {}),
            ...
            (this.onPopState = e => {
              ...
              if (!n) {
                ...
                this.changeState(
                  'replaceState',
                  (0, g.formatWithValidation)({ pathname: (0, R.addBasePath)(e), query: t }),
                  (0, d.getURL)()
                );
                return;
              }
              ...
              (!this.isSsr || a !== (0, R.addBasePath)(this.asPath) || l !== (0, R.addBasePath)(this.pathname)) &&
          ...
          if (
            ...
            this._initialMatchesMiddlewarePromise = D({ router: this, locale: _, asPath: o }).then(
              a => (
                ...
                this.changeState(
                  'replaceState',
                  a ? o : (0, g.formatWithValidation)({ pathname: (0, R.addBasePath)(e), query: t }),
                  o,
                  n
                ),
                a
    ...
    9308: (e, t) => {
      ...
      let r = 'nxtP',
        ...
        k = 'You can not use getInitialProps with getStaticProps. To use SSG, please remove your getInitialProps',
    ...
    9525: (e, t, r) => {
      ...
      class G extends g.default.Component {
        ...
        componentDidMount() {
          (this.scrollToHash(),
            n.isSsr &&
              (o.isFallback ||
                (o.nextExport && ((0, v.isDynamicRoute)(n.pathname) || location.search || W)) ||
                (o.props && o.props.__N_SSG && (location.search || W))) &&
              n
                .replace(
                  n.pathname +
                    '?' +
                    String((0, O.assign)((0, O.urlQueryToSearchParams)(n.query), new URLSearchParams(location.search))),
                  a,
      ...
      async function q(e) {
        ...
        if (
          ...
          (0, S.setConfig)({ serverRuntimeConfig: {}, publicRuntimeConfig: o.runtimeConfig || {} }),
          (a = (0, T.getURL)()),
        ...
        return (
          ...
          i
            ...
            .then(r => {
              ...
              ).then(t => ea({ ...e, err: u, Component: l, styleSheets: s, props: t }));
            })
        );
      }
      function $(e) {
      ...
      function er() {
        T.ST &&
          ...
          performance.getEntriesByName(Q.beforeRender, 'mark').length &&
            (performance.measure(J.beforeHydration, Q.navigationStart, Q.beforeRender),
      ...
      function en() {
        ...
        e.length &&
          (performance.getEntriesByName(Q.beforeRender, 'mark').length &&
            (performance.measure(J.routeChangeToRender, e[0].name, Q.beforeRender),
      ...
      function ea(e) {
        ...
        let b = (0, m.jsxs)(m.Fragment, {
          children: [
            ...
            (0, m.jsxs)(z, {
              children: [
                V(o, d),
                (0, m.jsx)(j.Portal, { type: 'next-route-announcer', children: (0, m.jsx)(w.RouteAnnouncer, {}) }),
              ],
            }),
          ],
        });
        ...
        let P = ((t = ee ? er : en), (0, m.jsx)(eo, { callbacks: [t, _], children: b }));
        return (
          Z
            ? (0, g.default.startTransition)(() => {
                Z.render(P);
              })
            : ((Z = E.default.hydrateRoot(y, P, { onRecoverableError: k.onRecoverableError })), (ee = !1)),
          h
        );
      }
      async function ei(e) {
      ...
      async function eu(e) {
        ...
        ((null == e ? void 0 : e.beforeRender) && (await e.beforeRender()), ei(r));
      }
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
